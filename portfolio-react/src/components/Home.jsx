  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='text-[#ff66c4]'>Hi, my name is</p>
        ...
        <p className='text-[#8892b0] py-4 max-w-[700px]'>with a background in Management Consulting. Looking to leverage my development skills to provide web applications that support business initiatives. Earned a certificate in web development from UC Berkeley.</p>
