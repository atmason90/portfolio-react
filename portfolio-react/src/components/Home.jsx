  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <img className='scale-50 mt-12 h-[500px] w-[500px] rounded-full' src="https://media-exp1.licdn.com/dms/image/C5603AQH0J5Cw8dVdiQ/profile-displayphoto-shrink_400_400/0/1590033296984?e=1658361600&v=beta&t=WzRO2p88XWmL8crX0kfHMKe4f_qO843pgoKJ8N232Ks" alt="Andrew Mason" />
